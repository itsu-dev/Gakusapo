...
public class IOUtils {
    ...
    public static String decodeTemplate(@NonNull String input, final @NonNull Map<String, String> data) {
        for (Map.Entry<String, String> entry : data.entrySet()) {
            input = input.replaceAll("#" + entry.getKey() + "#", Matcher.quoteReplacement(entry.getValue()));
        }
        return input;
    }
