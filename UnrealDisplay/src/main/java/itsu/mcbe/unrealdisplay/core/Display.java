...
public class Display implements Listener {
    ...
    private void takeImage() {
        Platform.runLater(() -> {
            //TODO
            BufferedImage bufferedImage = screenshot();//SwingFXUtils.fromFXImage(view.snapshot(null, null), null);
            setImage(bufferedImage);
        });
    }

    private BufferedImage screenshot() {
        return robot.createScreenCapture(new Rectangle(0, 0, 1080, 640));
    }
